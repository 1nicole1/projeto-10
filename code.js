...
//Adicione a condição para reduzir a vida de Sam quando ele encostar no carro.
  ...
  if ( 
   sam.isTouching(car1) ||
   //quando o sam tocar no car1 ele vai perder uma vida 
   sam.isTouching(car2) ||
   //quando o sam tocar no ca2 ele vai perder uma vida 
   sam.isTouching(car3) || 
   // quando o sam tocar no car3 ele vai perder uma vida
   sam.isTouching(car4)) 
   // quando o sam tocar no car4 ele vai perder uma vida
